...
description: Captured web frame of CCTV from a recent voyage to the Antarctic. The object detection used was YOLO. The idea was to capture wildlife. It was a lot of fun testing!
date: "2023-07-01"
url: https://unkey.dev
published: true
...
![Ship Fun GIF](https://raw.githubusercontent.com/hughsLab/my-github-page/main/assets/film/ship_fun.gif)

Captured web frame of CCTV from a recent voyage to the Antarctic. The object detection used was YOLO. The idea was to capture wildlife. It was a lot of fun testing!
